...
function Header() {
  ...
  return (
    <div className="max-w-screen flex flex-col">
      <div className="box-border flex items-center w-full justify-between border-b-[1px] mx-auto px-[20px] sticky top-0 text-black bg-white">
      ...
      <div className="w-full h-[60px] bg-slate-50 py-2">
        <form className="w-full md:w-[50%] h-full p-3 mx-auto flex items-center justify-center bg-white rounded-full">
          <input
            type="text"
